...
| TC08         | Deleting reminder list (Database)          | 1. On the main screen, where the reminder list is displayed, click on the three dots. <br />2. Click delete. | Is deleted                             | Not deleted                                                         | Fail      | Does not delete from the database |
...
| TC13         | Uncheck all reminders                      | 1. check all the reminders first. <br />2. And click the Uncheck All button.                                  | Uncheck all reminders                  | Unchecked                                                           | Pass      | Works as expected                 |
