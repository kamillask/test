...
|--------------|--------------------------------------------|--------------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------------------------------------------------|-----------|-----------------------------------|
| TC01         | Add ReminderList                           | 1. Click on the add button on the first screen.  2. Add a new list name                                | A new reminder list is created         | Is added                                                            | Pass      | May have to refresh the screen    |
| TC02         | Add reminder type                          | Click on the add button Check if the new type is stored in the spinner. Select the type                | A new reminder type is added           | Is added                                                            | Pass      | Works as expected                 |
| TC03         | Add a new Reminder                         | Type the new reminder inside the edit text. Click save button                                          | A new reminder name is added           | Is added                                                            | Pass      | Works as expected                 |
| TC04         | Add a new date                             | Select a new date from the date picker Click save button                                               | A new date is added                    | Is added                                                            | Pass      | Works as expected                 |
| TC05         | Add a new time                             | Select a new time from the time picker Click the save button.                                          | A new time is added                    | Is added                                                            | Pass      | Works as expected                 |
